...
<div class="content mx-auto col-12 col-sm-12 col-md-10 col-lg-10" style="margin-bottom: 5%;" >
    <table class="table mx-auto mt-auto table-responsive-sm table-responsive-md col-lg-12 " >
        ...
        $query2=mysqli_query($connection,"SELECT * FROM room where room_type='multiple'");
        if(mysqli_num_rows($query2)!=0) {
            ...
            foreach($query2 as $row){
                ...
                echo"<td>".'<img src="data:image/jpeg;base64,'.base64_encode( $row['room_image'] ).'" alt="multiple room"  class="img-responsive img-fluid">'."</td>";
                ...
                echo "<td><form action='multiple.php' method='POST'><input type='hidden'  name='upload' value='".$row['room_id']."'><input type='submit' value='IMAGE' class='btn btn-success'></form></td>";
                echo "<td><form action='multiple.php' method='POST'><input type='hidden'  name='update' value='".$row['room_id']."'><input type='submit' value='UPDATE' class='btn btn-primary'></form></td></tr>";
            }
        }
        ?>
    </table>
    ...
    <form action="insert_multiple.php" method="post" class="insert mx-auto col-11 col-sm-7 col-md-7 col-lg-4">
